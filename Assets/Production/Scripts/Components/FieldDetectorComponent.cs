...
{
	public class FieldDetectorComponent : MonoBehaviour
	{

		    [Header("Events")] 
			public GameObjectEvent OnDetectLogicalObject;

			public GameObjectEvent OnUndetectLogicalObject;
			[Header("Detection")]
			public List<Transform> LastSeenObjects = new List<Transform>();
			
			
			private Transform actualSeen;
			[Range(0.05f, 0.5f)]public float ComputeDelay;
			
			
			public bool DrawVisualisationMesh;
			...
			void LateUpdate()
			{
				if(DrawVisualisationMesh) DrawFieldOfView();
			}
			...
			public struct ViewCastInfo
			{
				...
				public float dst;
				public float angle;
				public Transform viewed;

				public ViewCastInfo(bool _hit, Vector3 _point, float _dst, float _angle, Transform view)
				{
					hit = _hit;
					point = _point;
					dst = _dst;
